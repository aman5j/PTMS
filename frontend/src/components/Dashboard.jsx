...
const useStyles = makeStyles((theme) => ({
  ...
  sidebar: {
    ...
    // display: "flex",
    // flexDirection: "column",
    // paddingTop: 0, // Remove, we'll add padding to items as needed
    // minHeight: "100vh",
    // position: "sticky",
    // top: 0,
    // transition: "width 0.2s",
  ...
  //     color: "#fff",
  //     "& svg": {
  //       color: "#fff", // icon color white on selected
  //     },
  //   },
  //   "&:hover": {
...
//   { text: "Users", link: "/dashboard/userstable", icon: <PeopleIcon /> },

//   // { text: "Profile", link: "/dashboard/profile", icon: <PeopleIcon /> },
//   {
//     text: "Add Property",
...
const Dashboard = () => {
 ...
 // Fetch users on mount
  ...
  const navItems = [
    { text: "Dashboard", link: "/dashboard", icon: <DashboardIcon /> },
    user.name == "Aman Prajapati"
      ? { text: "Users", link: "/dashboard/userstable", icon: <PeopleIcon /> }
      : "",
    user.name == "Aman Prajapati"
      ? {
          text: "Properties Table",
          link: "/dashboard/propertiestable",
          icon: <DomainIcon />,
        }
      : "",
  ...
  const settings = [
    "Profile",
    user.name == "Aman Prajapati" ? "Users" : "",
    user.name == "Aman Prajapati" ? "Properties" : "",
    // "Dashboard",
    "Logout",
  ];
    ...
    <div className={classes.root}>
      ...
      >
        {/* <Box sx={{ flexGrow: 0, justifyContent: 'right' }}>
          <Typography sx={{display: 'flex', justifyContent: 'right'}} align="right" color="textSecondary">
            <Tooltip title={user.name}> 
              <IconButton onClick={handleOpenUserMenu} sx={{ p: 0 }}>
                <Avatar
                  alt={user.name.toUpperCase()} //"Remy Sharp"
                  src="/static/images/avatar/2.jpg"
                />
              </IconButton>
            </Tooltip>
