...
export default function PropertyDetails() {
  ...
  // const [floorUsage, setFloorUsage] = React.useState("");
  // const [floorRentType, setFloorRentType] = React.useState("");
  // const [floorConstructionType, setFloorConstructionType] = React.useState("");
  ...
  useEffect(
    function () {
      console.dir("floorsData:", floorsData);
    },
    [floorsData]
  );
  ...
  const handleSubmit = async (event) => {
    ...
    console.log(
      `data of page is : 
        ...
        sewerConnection = ${sewerConnection}, isDisabled = ${isDisabled}, floorsData = ${floorsData}, frontView = ${frontView}, 
  ...
  return (
    ...
    <div>
      <Box sx={{ flexGrow: 1, maxWidth: 900 }}>
        <Typography variant="h5" gutterBottom align="left" color="black">
          Register New Property Details
        </Typography>
        ...
        <form onSubmit={handleSubmit} noValidate>
          ...
          <FloorWiseDetails
            ...
            setFloorsData={setFloorsData}
            // floorNo={floorNo}
            // setFloorNo={setFloorNo}
            // floorUsage={floorUsage}
            // setFloorUsage={setFloorUsage}
            // floorRentType={floorRentType}
            // setFloorRentType={setFloorRentType}
            // floorConstructionType={floorConstructionType}
            // setFloorConstructionType={setFloorConstructionType}
            // floorArea={floorArea}
          ...
          <Grid size={12} item xs={12}>
            <Button
              ...
              sx={{
                ...
                fontWeight: 600,
                fontSize: "1.1rem",
                background: "linear-gradient(90deg, #800080 0%, #a020f0 100%)",
                color: "primary",
